...
class Custom_Post_Type_Image_Upload {
	...
	public function init() {
	    register_post_type( 'artistAttachment', array( 'public' => true, 'label' => 'Artist attachment' ) );
	}
	...
	public function enter_title_here( $text, $post ) {
		if ( $post->post_type == 'artistAttachment' ) return __( 'Book Title' );
		return $text;
	}
	...
	public function meta_boxes() {
		add_meta_box( 'book-image', __( 'Book Image' ), array( &$this, 'book_image_meta_box' ), 'movement', 'normal', 'high' );
	}
